    ...
    <section id="why-choose-us" style={{ padding: 'clamp(60px, 8vw, 120px) clamp(16px, 4vw, 28px)', background: '#FAFAFA' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div className="reveal" style={{ textAlign: 'center', marginBottom: 64 }}>
          <p style={{ fontFamily: 'Instrument Sans', fontWeight: 700, fontSize: 21, letterSpacing: '0.14em', color: '#4CAF50', marginBottom: 12 }}>{w.tag}</p>
          <h2 style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 'clamp(42px,5vw,64px)', letterSpacing: '-0.04em', color: '#0D3F6B' }}>{w.title}</h2>
        </div>
        ...
        <div className="grid-mobile-1" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56, alignItems: 'start' }}>
          ...
          <div className="reveal" style={{ position: 'relative' }}>
            <div style={{
              ...
              <div style={{ position: 'absolute', bottom: 28, left: 28, right: 28 }}>
                <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 24, color: '#fff', letterSpacing: '-0.02em', marginBottom: 6 }}>
                  Caring for you, right where you are
                </p>
                <p style={{ fontFamily: 'Instrument Sans', fontSize: 21, color: 'rgba(255,255,255,0.75)' }}>
                  Kigali, Rwanda 🇷🇼
                </p>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div>
                <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 24, color: '#0D3F6B', lineHeight: 1, letterSpacing: '-0.03em' }}>500+</p>
            ...
            <div style={{
              ...
              <div>
                <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 21, color: '#0D3F6B', lineHeight: 1, letterSpacing: '-0.03em' }}>4.9★</p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, paddingTop: 8 }}>
            <p className="reveal" style={{ fontFamily: 'Instrument Sans', color: '#9CA3AF', fontSize: 21, lineHeight: 1.75, marginBottom: 8 }}>
              {w.sub}
            </p>
            ...
            {features.map((f, i) => (
              <div key={i} className="reveal" style={{
                ...
                <div style={{ width: 46, height: 46, borderRadius: 14, background: f.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 26, flexShrink: 0 }}>
                  {f.emoji}
                </div>
                <div>
                  <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 700, fontSize: 21, color: '#0D3F6B', letterSpacing: '-0.02em', marginBottom: 4 }}>{f.title}</p>
                  <p style={{ fontFamily: 'Instrument Sans', fontSize: 21, color: '#9CA3AF', lineHeight: 1.7 }}>{f.desc}</p>
                </div>
              </div>
            ))}
            ...
            <div className="reveal cta-bar" style={{
              ...
              <p style={{ fontFamily: 'Instrument Sans', fontSize: 21, color: 'rgba(255,255,255,0.7)', lineHeight: 1.6 }}>
                {w.infoBar}
              </p>
              <a href="tel:+250795628517" style={{
                ...
                fontSize: 21, textDecoration: 'none', whiteSpace: 'nowrap',
